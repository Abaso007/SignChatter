...
path='https://github.com/zainasif125/Mediapipe-API/blob/ec42b62996ef718b9849d7dcbe2115e1379ee53a/NewAction3.h5' #path to the model change it with the path of your own
...
async def read_root(file: UploadFile = File()):
    path2=f"https://github.com/zainasif125/Mediapipe-API/blob/ec42b62996ef718b9849d7dcbe2115e1379ee53a/videos/{file.filename}" # path to the videos being saved. Change it to your own local path
    file_location = path2
